...
<div align="center">
	    ...
	    // 4 columns: ID,c1,c2,c3
            var matrix = [ <?php
	$j=0;
	$resultheat = mysql_query("SELECT ano, (SUM(oficialismos) / SUM(votos_oficialistas)) AS indice, votos_oficialistas FROM disciplina WHERE diputadoId = $diputadoId GROUP BY ano ORDER BY ano ASC");
